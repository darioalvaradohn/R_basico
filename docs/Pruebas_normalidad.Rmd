...
Para realizar algunos métodos estadísticos es necesario que nuestros datos cumplan algunos supuestos. Algunas pruebas requieren que la varianza de los datos cumpla una **distribución normal** y que tenga **homogeneidad**.
