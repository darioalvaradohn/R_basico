---
title: "Pruebas de Supuestos Estadísticos"
...
[Volver arriba](Pruebas_normalidad.html)
...
multivariada <- mvn(data = datos[,2:4], # seleccionamos las variables de la tabla (columnas de la 2 a la 4)
                    mvn_test = "royston", # indicamos el método para calcular la normalidad multivariada
                    univariate_test = "SW") # indicamos el método para calcular la normalidad univariada
