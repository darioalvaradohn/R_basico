...
```{r}
t.test(altura ~ sexo, data = datos) # Se coloca primero la variable respuesta (dependiente) y después la variable predictora (independiente) que debe ser categórica, separadas por una `~`.
```
